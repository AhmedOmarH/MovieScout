  ...
  return (
    <div>
      ...
      <div className="mt-8">
        ...
        <div className="carousel-container" style={{ maxWidth: '350px', margin: '0 auto', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.5)', backgroundColor: 'black', padding: '10px' }}>
      ...
      <div className="mt-8 mb-12 flex flex-col items-center">
        ...
        {newReleases.length > 8 && (
          <button
            ...
            className="mt-4 bg-gray-800 text-white font-semibold py-2 px-4 rounded flex items-center"
          >
      ...
      <div className="mt-8 mb-12 flex flex-col items-center">
        ...
        {/* See More Button */}
        {topRated.length > 8 && (
          <button onClick={() => setShowMoreTopRated(!showMoreTopRated)} className="mt-4 bg-gray-800 text-white font-semibold py-2 px-4 rounded flex items-center">
      ...
      <div className="mt-8 mb-12 flex flex-col items-center">
        ...
        {/* See More Button */}
        {upcoming.length > 8 && (
          <button onClick={() => setShowMoreUpcoming(!showMoreUpcoming)} className="mt-4 bg-gray-800 text-white font-semibold py-2 px-4 rounded flex items-center">
