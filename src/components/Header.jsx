        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 bg-white text-gray-800 rounded shadow-lg w-48">
              <ul className="py-2">
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer">User Profile</li>
               <Link to='/login' ><li className="px-4 py-2 hover:bg-gray-200 cursor-pointer">Log In </li></Link> 
               <Link to='/signup' ><li className="px-4 py-2 hover:bg-gray-200 cursor-pointer">Sign Up </li></Link> 
              </ul>
            </div>
          )}
        </div>
